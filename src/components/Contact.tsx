...
const CONTACT_EMAIL = "andy.samyn2005@gmail.com";
...
const contactLinks = [
  ...
  },*/
  {
    ...
    label: "LinkedIn",
    value: "https://www.linkedin.com/in/andy-samyn-4797632a8/",
    href: "https://www.linkedin.com/in/andy-samyn-4797632a8/",
  ...
  },
  {
    ...
    label: "Email",
    value: "andy.samyn2005@gmail.com",
    href: "mailto:andy.samyn2005@gmail.com",
...
export default function Contact() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    setSuccess("Votre client mail va s'ouvrir pour envoyer le message.");
      ...
      <div className="max-w-3xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted text-lg">
            Une idée de projet ? Une opportunité ? N'hésitez pas à me faire
            signe !
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-14">
          {contactLinks.map((link) => (
            <a
              ...
              className={`gradient-border bg-card rounded-2xl p-6 w-full sm:w-[260px] flex flex-col items-center gap-3 text-muted transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${link.color}`}
            >
              {link.icon}
        ...
        <div className="gradient-border bg-card rounded-2xl p-8">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                <label className="text-muted text-sm block mb-1" htmlFor="name">
                  Nom
                </label>
                <input
                  id="name"
              ...
              <div>
                <label
                  className="text-muted text-sm block mb-1"
                  htmlFor="email"
                >
                  Email
                </label>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-primary to-secondary text-white font-semibold rounded-xl hover:opacity-90 transition-opacity duration-200 shadow-lg shadow-primary/30 flex items-center justify-center gap-2"
            >
        ...
        {/* Footer */}
        <p className="flex items-center justify-center gap-1 text-center text-muted text-sm mt-12">
          © {new Date().getFullYear()} — Fait avec{" "}
          <Heart className="w-4 h-4 text-primary" /> et React
        </p>
      </div>
    </section>
  );
